...
export class BeanServiceService {
  ...
  constructor() {
    ...
    const now = new Date();
    //  subtract a 30 seconds to make sure it runs after midnight. Otherwise updateDate won't recognise the new day
    ...
    console.log('Ticking timer for till midnight: ' + timeTillMidnight);
  ...
  increment() {
    ...
    this.statusControl.addStatus('Backup if something went wrong with priority add. ' + this.runningTotal);
